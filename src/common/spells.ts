const spells = {
  ...
  prestidigitation: {
    ...
    description: [
      require('../resources/spell-gifs/0/prestidigitation-desc.jpg')
    ]
  },
  'produce-flame': {
    level: 0,
  ...
  'animal-friendship': {
    ...
    description: [
      require('../resources/spell-gifs/1/animal-friendship-desc.jpg')
    ]
  },
  'armour-of-agathys': {
    level: 1,
  ...
  'comprehend-languages': {
    ...
    description: [
      require('../resources/spell-gifs/1/comprehend-languages-desc.jpg')
    ]
  },
  'create-or-destroy-water': {
    ...
    description: [
      require('../resources/spell-gifs/1/create-or-destroy-water-desc.jpg')
    ]
  },
  'cure-wounds': {
    level: 1,
  ...
  'detect-evil-and-good': {
    ...
    description: [
      require('../resources/spell-gifs/1/detect-evil-and-good-desc.jpg')
    ]
  },
  'detect-magic': {
    level: 1,
  ...
  'detect-poison-and-disease': {
    ...
    description: [
      require('../resources/spell-gifs/1/detect-poison-and-disease-desc.jpg')
    ]
  },
  'disguise-self': {
    level: 1,
  ...
  'expeditious-retreat': {
    ...
    description: [
      require('../resources/spell-gifs/1/expeditious-retreat-desc.jpg')
    ]
  },
  'faerie-fire': {
    level: 1,
  ...
  'protection-from-evil-and-good': {
    ...
    description: [
      require('../resources/spell-gifs/1/protection-from-evil-and-good-desc.jpg')
    ]
  },
  'purify-food-and-drink': {
    ...
    description: [
      require('../resources/spell-gifs/1/purify-food-and-drink-desc.jpg')
    ]
  },
  'ray-of-sickness': {
    level: 1,
  ...
  'speak-with-animals': {
    ...
    description: [
      require('../resources/spell-gifs/1/speak-with-animals-desc.jpg')
    ]
  },
  "tasha's-hideous-laughter": {
    ...
    description: [
      require("../resources/spell-gifs/1/tasha's-hideous-laughter-desc.jpg")
    ]
  },
  "tenser's-floating-disk": {
    ...
    description: [
      require("../resources/spell-gifs/1/tenser's-floating-disk-desc.jpg")
    ]
  },
  'thunderous-smite': {
    level: 1,
  ...
  'animal-messenger': {
    ...
    description: [
      require('../resources/spell-gifs/2/animal-messenger-desc.jpg')
    ]
  },
  'arcane-lock': {
    level: 2,
  ...
  'blindness-and-deafness': {
    ...
    description: [
      require('../resources/spell-gifs/2/blindness-and-deafness-desc.jpg')
    ]
  },
  blur: {
    level: 2,
  ...
  'enlarge-and-reduce': {
    ...
    description: [
      require('../resources/spell-gifs/2/enlarge-and-reduce-desc.jpg')
    ]
  },
  enthrall: {
    level: 2,
  ...
  'lesser-restoration': {
    ...
    description: [
      require('../resources/spell-gifs/2/lesser-restoration-desc.jpg')
    ]
  },
  levitate: {
    level: 2,
  ...
  'locate-animals-or-plants': {
    ...
    description: [
      require('../resources/spell-gifs/2/locate-animals-or-plants-desc.jpg')
    ]
  },
  'locate-object': {
    level: 2,
  ...
  "melf's-acid-arrow": {
    ...
    description: [
      require("../resources/spell-gifs/2/melf's-acid-arrow-desc.jpg")
    ]
  },
  'mirror-image': {
    level: 2,
  ...
  "nystul's-magic-aura": {
    ...
    description: [
      require("../resources/spell-gifs/2/nystul's-magic-aura-desc.jpg")
    ]
  },
  'pass-without-trace': {
    level: 2,
    ...
    description: [
      require('../resources/spell-gifs/2/pass-without-trace-desc.jpg')
    ]
  },
  'phantasmal-force': {
    level: 2,
  ...
  'prayer-of-healing': {
    ...
    description: [
      require('../resources/spell-gifs/2/prayer-of-healing-desc.jpg')
    ]
  },
  'protection-from-poison': {
    ...
    description: [
      require('../resources/spell-gifs/2/protection-from-poison-desc.jpg')
    ]
  },
  'ray-of-enfeeblement': {
    level: 2,
    ...
    description: [
      require('../resources/spell-gifs/2/ray-of-enfeeblement-desc.jpg')
    ]
  },
  'rope-trick': {
    level: 2,
  ...
  'see-invisibility': {
    ...
    description: [
      require('../resources/spell-gifs/2/see-invisibility-desc.jpg')
    ]
  },
  shatter: {
    level: 2,
  ...
  'spiritual-weapon': {
    ...
    description: [
      require('../resources/spell-gifs/2/spiritual-weapon-desc.jpg')
    ]
  },
  suggestion: {
    level: 2,
  ...
  'create-food-and-water': {
    ...
    description: [
      require('../resources/spell-gifs/3/create-food-and-water-desc.jpg')
    ]
  },
  "crusader's-mantle": {
    level: 3,
  ...
  'dispel-magic': {
    level: 3,
    gif: true,
    image: require('../resources/spell-gifs/3/dispel-magic.gif'),
    description: [require('../resources/spell-gifs/3/dispel-magic-desc.jpg')]
  },
  'elemental-weapon': {
    level: 3,
    gif: false,
  ...
  'hypnotic-pattern': {
    ...
    description: [
      require('../resources/spell-gifs/3/hypnotic-pattern-desc.jpg')
    ]
  },
  "leomund's-tiny-hut": {
    level: 3,
    ...
    description: [
      require("../resources/spell-gifs/3/leomund's-tiny-hut-desc.jpg")
    ]
  },
  'lightning-arrow': {
    level: 3,
  ...
  'mass-healing-word': {
    ...
    description: [
      require('../resources/spell-gifs/3/mass-healing-word-desc.jpg')
    ]
  },
  'meld-into-stone': {
    level: 3,
  ...
  'protection-from-energy': {
    ...
    description: [
      require('../resources/spell-gifs/3/protection-from-energy-desc.jpg')
    ]
  },
  'remove-curse': {
    level: 3,
  ...
  'speak-with-plants': {
    ...
    description: [
      require('../resources/spell-gifs/3/speak-with-plants-desc.jpg')
    ]
  },
  'spirit-guardians': {
    level: 3,
    ...
    description: [
      require('../resources/spell-gifs/3/spirit-guardians-desc.jpg')
    ]
  },
  'stinking-cloud': {
    level: 3,
  ...
  'conjure-minor-elementals': {
    ...
    description: [
      require('../resources/spell-gifs/4/conjure-minor-elementals-desc.jpg')
    ]
  },
  'conjure-woodland-beings': {
    ...
    description: [
      require('../resources/spell-gifs/4/conjure-woodland-beings-desc.jpg')
    ]
  },
  'control-water': {
    level: 4,
    ...
    description: [
      require('../resources/spell-gifs/4/control-water1-desc.jpg'),
      require('../resources/spell-gifs/4/control-water2-desc.jpg')
    ]
  },
  'death-ward': {
    level: 4,
  ...
  "evard's-black-tentacles": {
    level: 4,
    gif: true,
    image: require("../resources/spell-gifs/4/evard's-black-tentacles.gif"),
    description: [
      require("../resources/spell-gifs/4/evard's-black-tentacles-desc.jpg")
    ]
  },
  fabricate: {
    level: 4,
  ...
  'freedom-of-movement': {
    ...
    description: [
      require('../resources/spell-gifs/4/freedom-of-movement-desc.jpg')
    ]
  },
  'giant-insect': {
    level: 4,
  ...
  'greater-invisibility': {
    ...
    description: [
      require('../resources/spell-gifs/4/greater-invisibility-desc.jpg')
    ]
  },
  'guardian-of-faith': {
    level: 4,
    ...
    description: [
      require('../resources/spell-gifs/4/guardian-of-faith-desc.jpg')
    ]
  },
  'hallucinatory-terrain': {
    ...
    description: [
      require('../resources/spell-gifs/4/hallucinatory-terrain-desc.jpg')
    ]
  },
  'ice-storm': {
    level: 4,
  ...
  "leomund's-secret-chest": {
    ...
    description: [
      require("../resources/spell-gifs/4/leomund's-secret-chest-desc.jpg")
    ]
  },
  'locate-creature': {
    level: 4,
  ...
  "mordenkainen's-faithful-hound": {
    ...
    description: [
      require("../resources/spell-gifs/4/mordenkainen's-faithful-hound-desc.jpg")
    ]
  },
  "mordenkainen's-private-sanctum": {
    ...
    description: [
      require("../resources/spell-gifs/4/mordenkainen's-private-sanctum-desc.jpg")
    ]
  },
  "otiluke's-resilient-sphere": {
    ...
    description: [
      require("../resources/spell-gifs/4/otiluke's-resilient-sphere-desc.jpg")
    ]
  },
  'phantasmal-killer': {
    level: 4,
    ...
    description: [
      require('../resources/spell-gifs/4/phantasmal-killer-desc.jpg')
    ]
  },
  polymorph: {
    level: 4,
  ...
  'animate-object': {
    ...
    description: [
      require('../resources/spell-gifs/5/animate-object1-desc.jpg'),
      require('../resources/spell-gifs/5/animate-object2-desc.jpg')
    ]
  },
  'antilife-shell': {
    level: 5,
  ...
  "bigby's-hand": {
    ...
    description: [
      require("../resources/spell-gifs/5/bigby's-hand1-desc.jpg"),
      require("../resources/spell-gifs/5/bigby's-hand2-desc.jpg")
    ]
  },
  'circle-of-power': {
    level: 5,
  ...
  'commune-with-nature': {
    ...
    description: [
      require('../resources/spell-gifs/5/commune-with-nature-desc.jpg')
    ]
  },
  'cone-of-cold': {
    level: 5,
  ...
  'conjure-elemental': {
    ...
    description: [
      require('../resources/spell-gifs/5/conjure-elemental-desc.jpg')
    ]
  },
  'conjure-volley': {
    level: 5,
  ...
  'contact-other-plane': {
    ...
    description: [
      require('../resources/spell-gifs/5/contact-other-plane-desc.jpg')
    ]
  },
  contagion: {
    level: 5,
  ...
  'dispel-evil-and-good': {
    ...
    description: [
      require('../resources/spell-gifs/5/dispel-evil-and-good-desc.jpg')
    ]
  },
  'dominate-person': {
    level: 5,
  ...
  'greater-restoration': {
    ...
    description: [
      require('../resources/spell-gifs/5/greater-restoration-desc.jpg')
    ]
  },
  hallow: {
    level: 5,
    ...
    description: [
      require('../resources/spell-gifs/5/hallow1-desc.jpg'),
      require('../resources/spell-gifs/5/hallow2-desc.jpg')
    ]
  },
  'hold-monster': {
    level: 5,
  ...
  'mass-cure-wounds': {
    ...
    description: [
      require('../resources/spell-gifs/5/mass-cure-wounds-desc.jpg')
    ]
  },
  mislead: {
    level: 5,
  ...
  "rary's-telepathic-bond": {
    ...
    description: [
      require("../resources/spell-gifs/5/rary's-telepathic-bond-desc.jpg")
    ]
  },
  reincarnate: {
    level: 5,
  ...
  'teleportation-circle': {
    ...
    description: [
      require('../resources/spell-gifs/5/teleportation-circle-desc.jpg')
    ]
  },
  'tree-stride': {
    level: 5,
